...
void MX_FDCAN2_Init(void)
{
  ...
  hfdcan2.Init.MessageRAMOffset = 38;
  hfdcan2.Init.StdFiltersNbr = 2;
  hfdcan2.Init.ExtFiltersNbr = 0;
  /* Four C620 controllers can report in the same millisecond. */
...
void MX_FDCAN3_Init(void)
{
  ...
  /* FDCAN2 FIFO0 gained one 8-byte element (four Message RAM words). */
  hfdcan3.Init.MessageRAMOffset = 80;
  hfdcan3.Init.StdFiltersNbr = 2;
  hfdcan3.Init.ExtFiltersNbr = 0;
  hfdcan3.Init.RxFifo0ElmtsNbr = 3;
  hfdcan3.Init.RxFifo0ElmtSize = FDCAN_DATA_BYTES_8;
  hfdcan3.Init.RxFifo1ElmtsNbr = 3;
